...
sudo mdadm --create --verbose /dev/md103 --level=0 --raid-devices=2 /dev/nvme0n1 /dev/nvme1n1

sudo modprobe brd rd_nr=1 rd_size=16777216

sudo mkfs.xfs /dev/md103 -l size=2038m,logdev=/dev/ram0 -d agcount=8 crc=0 -f
